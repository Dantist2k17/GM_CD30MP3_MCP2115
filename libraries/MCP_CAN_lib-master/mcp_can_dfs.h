...
//Opel Corsa MSCAN
#define MCP_8MHz_95k2BPS_CFG1 (0x42)    /* Increased SJW       */
#define MCP_8MHz_95k2BPS_CFG2 (0xE3)    /* Enabled SAM bit     */
#define MCP_8MHz_95k2BPS_CFG3 (0x83)    /* Sample point at 75% */
